...
namespace Shicho.Patcher.TreeInstancePatch
{
    ...
    {
        static bool Prefix(ref RenderManager.CameraInfo cameraInfo, ref TreeInfo info, Vector3 position, float scale, float brightness)
        {
    ...
    class PopulateGroupData
    {
        ...
        static bool Prefix(TreeInfo info, Vector3 position, float scale, float brightness, ref int vertexIndex, ref int triangleIndex, Vector3 groupPosition, RenderGroup.MeshData data, ref Vector3 min, ref Vector3 max, ref float maxRenderDistance, ref float maxInstanceDistance)
        {
